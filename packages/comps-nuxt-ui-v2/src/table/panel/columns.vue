<template>
  ...
  <UFormGroup :help="helpText" class="cx-columns">
    <div class="cx-panel-columns">
      <label v-for="item in value" :key="item.id" class="cx-panel-columns__row">
        <input
          type="checkbox"
      ...
      <p v-if="!value.length" class="cx-panel-columns__empty">暂无可配置列</p>
    </div>
  </UFormGroup>
</template>
