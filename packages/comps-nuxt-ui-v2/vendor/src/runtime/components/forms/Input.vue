...
import { uiColors, looseToNumber, mergeConfig, twMerge } from '../../utils'
...
export default defineComponent({
  ...
  props: {
    ...
    color: {
      ...
      validator(value: string) {
        return [...uiColors, ...Object.keys(config.color)].includes(value)
      }
    },
    variant: {
  ...
  setup(props, { emit, slots }) {
    ...
    const leadingIconClass = computed(() => {
      return twJoin(
        ui.value.icon.base,
        color.value && uiColors.includes(color.value) && ui.value.icon.color.replaceAll('{color}', color.value),
