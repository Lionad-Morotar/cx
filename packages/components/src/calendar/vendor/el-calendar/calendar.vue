...
// @ts-nocheck
// 原样 vendor 自 element-plus@2.14.3，其源码为 el-plus 自身 tsconfig 编写；
// 本仓 strict 配置（noUncheckedIndexedAccess 等）不适用于此第三方代码，故跳过类型检查。
import { computed } from 'vue'
import { ElButton, ElButtonGroup } from '../shims/button'
import { useLocale, useNamespace } from '../shims/hooks'
