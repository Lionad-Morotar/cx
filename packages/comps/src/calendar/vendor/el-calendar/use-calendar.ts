// @ts-nocheck
// 原样 vendor 自 element-plus@2.14.3；strict 配置不适用，跳过类型检查（见同目录 README）。
import { computed, ref } from 'vue'
import dayjs from 'dayjs'
import { useLocale } from '../shims/hooks'
import { debugWarn, isArray, isDate } from '../shims/utils'
import { INPUT_EVENT, UPDATE_MODEL_EVENT } from '../shims/constants'
