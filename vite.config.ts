...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      '#app':
        '/Users/lionad/Github/Lionad-Morotar/cx/packages/components-nuxt-ui-v4/vendor/shims/imports.ts',
      '#imports':
        '/Users/lionad/Github/Lionad-Morotar/cx/packages/components-nuxt-ui-v4/vendor/shims/imports.ts',
      '#build/app.config':
        '/Users/lionad/Github/Lionad-Morotar/cx/packages/components-nuxt-ui-v4/vendor/shims/app.config.ts',
      '#ui-colors':
        '/Users/lionad/Github/Lionad-Morotar/cx/packages/components-nuxt-ui-v4/vendor/shims/ui-colors.d.ts',
      'nuxt/schema':
        '/Users/lionad/Github/Lionad-Morotar/cx/packages/components-nuxt-ui-v4/vendor/shims/nuxt-schema.d.ts',
    },
  },
  test: {
    include: [
